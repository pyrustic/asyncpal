...
[Home](/docs/api/README.md) | [Project](/README.md) | [Module](/docs/api/modules/asyncpal/pool/processpool/README.md) | [Source](/src/asyncpal/pool/processpool.py)
...
| Field | Value |
| --- | --- |
| \_abc\_impl | `<_abc._abc_data object at 0x74ae8c3fb000>` |
...
```python
def __init__(self, *, name='SingleProcessPool', idle_timeout=60, initializer=None, init_args=None, init_kwargs=None, finalizer=None, final_args=None, final_kwargs=None, max_tasks_per_worker=None, mp_context=None):
    ...
```
